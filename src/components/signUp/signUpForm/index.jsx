        ...
        <div className="pt-20 px-16">
          ...
          <form onSubmit={handleSubmit} className="py-5" action="">
            <div className="text-sm mt-2 font-sans mr-7">
              <input name="email" className="w-96 focus:outline-none focus: border-b-2 focus:border-green-500" type="text" placeholder="Enter your email"></input>
            </div>
            <div className="flex justify-between pt-4">
              <div className="text-sm mt-8 font-sans mr-3">
                <input name="firstName" className=" focus:outline-none focus: border-b-2 focus:border-green-500" type="text" placeholder="Your first name"></input>
              </div>
               <div className="text-sm mt-8 font-sans mr-7">
                <input name="lastName" className=" focus:outline-none focus: border-b-2 focus:border-green-500" type="text" placeholder="Your last name"></input>
              </div>
            </div>
            
            <div className="text-sm font-sans flex pt-11">
              <input name="password" className="w-80 focus:outline-none focus: border-b-2 focus:border-green-500" type="password" placeholder="Type your password here"></input>
